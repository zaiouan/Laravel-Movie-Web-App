                        ...
                        <div class=" shadow-md rounded my-6">
                            <table class="min-w-max w-full table-auto">
                                ...
                                <tr class="bg-gray-600 text-gray-200 uppercase text-sm leading-normal">
                                    ...
                                    <th class="py-3 px-6 text-left">Casts</th>
                                    ...
                                    <tr class="border-b border-gray-800 hover:bg-gray-900">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            @foreach($actor->series as $movie)
                                                <span
                                                    class=" text-purple-100 py-1 px-3 rounded-full text-xs"><b>{{$movie->title}}</b> as
                                                <b>
                                                    <?php $character = \App\Models\actor_movie::where('serie_id', $movie->id)->where('actor_id', $actor->id)->get(); ?>
