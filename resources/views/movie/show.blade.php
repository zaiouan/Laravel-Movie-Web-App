        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                <div class="flex">
                    ...
                    @role('user')
                    <livewire:favorite :rec="$movie->id" />
                    @endrole
                    </div>
                </div>
            ...
            <div class="movie-cast border-b border-gray-800">
                <div class="container mx-auto px-4 py-16">
                    ...
                    @if(\App\Models\actor_movie::where('movie_id',$movie->id)->whereNotNull('actor_id')->exists())
                                ...
                                <div class="mt-8">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="text-sm text-gray-400">
                                            <?php $character = \App\Models\actor_movie::where('movie_id', $movie->id)->where('actor_id', $cast->id)->get(); ?>
            ...
            <div class="movie-images" x-data="{ isOpen: false, image: ''}">
                <div class="container mx-auto px-4 py-16">
                    ...
                    @if(\App\Models\Image::where('movie_id',$movie->id)->exists())
